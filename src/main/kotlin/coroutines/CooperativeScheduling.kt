...
object CooperativeScheduling {
    ...
    // functions that can suspend a coroutine -- semantic blocking
    // yield()
    // delay(...)
    // join(), await()/awaitAll()

    // never run CPU-intensive coroutines without some suspension points otherwise computing resource starvation
